...
\date{15 марта}\ydate{2016}%дата получения
\dateen{May 15,}
\firstpage{1}%начальная страница статьи

%% поля, заполняемые автором
\title{Об оформлении отчета по проделанной работе в рамках Научно-исследовательского семинара "Введение в специальность"}
\titlecr{Оформление отчета для НИС}
\author{Белов А.В., Манита Л.А., Щур Л.Н., ассистенты: Гуськова М., Фадеева М.}
%\author{Иванов~И.\,И.${}^{1}$, Колесникова О.П.${}^{2}$}%Фамилия И.О. автора, номер ссылки на финансовую поддержку в пункте Благодарности
\authorcr{Белов А.В., Манита Л.А., Щур Л.Н..}%Фамилия И.О. автора для строки с авторским знаком
...
\shorttitle{НИС Введение в специальность}
...
\authorinform{
\\Белов Александр Владимирович, канд. техн. наук, доцент, \\НИУ ВШЭ МИЭМ им. А.Н.Тихонова\\ ул. Мясницкая, 20, г.Москва,  Россия, 101000 \\e-mail: avbelov@hse.ru
\vspace{4pt}	
...
\begin{abstract}
	...
	ФФайл является рекомендацией по структуре и оформлению научно-исследовательской работы, проделанной в рамках научно-исследовательского семинара "Введение в специальность"
\end{abstract}
